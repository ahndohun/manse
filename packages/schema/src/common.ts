...
export const IdentifierSchema = z
  ...
  .regex(
    /^[a-z][a-z0-9]*(?:[._-][a-z0-9]+)*$/,
    "Use a stable lowercase identifier containing letters, digits, dots, underscores, or hyphens",
  );
...
export const SafeRelativeAssetPathSchema = z
  ...
  .refine(
    isSafeRelativePath,
    "Use a relative in-pack path without traversal, encoded traversal, queries, or fragments",
  );
...
export function duplicateValues(values: readonly string[]): Set<string> {
